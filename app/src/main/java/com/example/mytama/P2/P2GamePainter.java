...
public class P2GamePainter extends Painter
{
  ...
  public static void drawFinalGameResults() {
    ...
    drawSpriteAt(P2Graphics.hashMap.get("num"+P2Game.score), 2, 8);
    drawSpriteAt(P2Graphics.hashMap.get("vs"), 8 ,8);
    drawSpriteAt(P2Graphics.hashMap.get("num"+(5-P2Game.score)), 18, 8);
  ...
  public static void showGameResult(){
    ...
    if (P2Game.answer == "higher")
      drawSpriteAt(P2Graphics.hashMap.get(Tama.character + "_right"), 16-W/2, y);
    else
      drawSpriteAt(P2Graphics.hashMap.get(Tama.character + "_left"),16-W/2, y);
    //On affiche les chiffres
    drawSpriteAt(P2Graphics.hashMap.get("num"+P2Game.givenNumber), 0, 0);
    drawSpriteAt(P2Graphics.hashMap.get("num"+P2Game.secretNumber), 28, 0);
  ...
  public static void showPlaying() {
    int x = Tama.x, y = Tama.y;
    int W = Tama.W, H = Tama.H;
    drawSpriteAt(P2Graphics.hashMap.get(Tama.character+"_play_"+(MainActivity.even+1)), 16 - W/2, y);
    drawSpriteAt(P2Graphics.hashMap.get("num"+P2Game.givenNumber), 0, 0);
  ...
  public static void showGameIntroScreen() {
    ...
    canvas.drawBitmap(P2Graphics.hashMap.get("empty_heart"), null, new Rect(Math.max(240+offsetX-k,offsetX-80),80+offsetY,320+offsetX-k,160+offsetY),paint);
    canvas.drawBitmap(P2Graphics.hashMap.get(Tama.character+"_play_1"),
                                   null,
